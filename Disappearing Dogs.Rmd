...
All dogs go to heaven, but some go upstate first.

This study looks at what dogs disappear from the New York City license registry; that is,
if a dog shows up in one year, does its license get renewed later? And what affects that 
...
what puppies might be unhappy in the city.

# Data creation

We start with teh full dog name list, and filter down to clean names and exclude any duplicate licenses.
...
from the reference to the outcome corpus, we get a column that indicates 
